...
class SingleGroup extends Component {
  ...
  render(){
    return(
     ...
     <div className={this.state.isFlipped ? "flip-card card-flip-motion" : "flip-card"}>
      <div className={this.state.isFlipped ? "flip-card-inner card-flip-motion" : "flip-card-inner"}>
